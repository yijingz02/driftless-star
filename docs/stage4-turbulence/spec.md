...
```
docker build --build-arg ENVIRONMENT=stage-4-spectrax stages/        # CPU
docker build --build-arg ENVIRONMENT=stage-4-spectrax-gpu --build-arg CUDA_VERSION=12 stages/  # GPU
```
